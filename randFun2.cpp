...
int main()
{
	...
	int *maxPtr = &maxNum, *minPtr = &minNum, *valPtr = &val;//initialize and store pointers at variable addresses
	...
	while (userState == 'Y')
	{
	rand_int(minPtr, maxPtr, valPtr); //call the rand function with pointer variables
